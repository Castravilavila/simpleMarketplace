...
public class UserController {
    ...
    @ApiOperation(value="find all Users From Db",
            response =List.class)
    @ApiResponses(value = {@ApiResponse(code = 200, message = "SUCCES",response = List.class)})
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "SUCCES",response = UserDto.class)})
